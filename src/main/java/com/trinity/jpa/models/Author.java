...
@SuperBuilder // Patron que nos ayuda a crear objetos
public class Author extends BaseEntity{
        //@Id // Hacemos que este ID sea una llave primaria de esta identidad
        //@GeneratedValue //(strategy = GenerationType.AUTO) // Especifica cómo se generará automáticamente el valor de una
         ...
         * 
         */
        @ManyToMany(mappedBy = "authors") //Definimos al "Dueño" de esa relacion, que es responsable de la llave foranea 
